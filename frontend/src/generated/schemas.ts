...
export const SCHEMAS: Record<string, unknown> = {
  "AllSetting": {
    "description": "AllSetting contains all configuration settings for the dune panel including web server, Telegram bot, and subscription settings.",
    "properties": {
      "clientIpJobInterval": {
        "description": "How often the IP-limit scan runs",
        "maximum": 86400,
        "minimum": 1,
        "type": "integer"
      },
      ...
      "nodeHeartbeatInterval": {
        "description": "How often remote nodes are health-checked",
        "maximum": 86400,
        "minimum": 1,
        "type": "integer"
      },
      "nodeTrafficInterval": {
        "description": "How often remote-node traffic is synced",
        "maximum": 86400,
        "minimum": 1,
        "type": "integer"
      },
      ...
      "trafficJobInterval": {
        "description": "Background-job cadences (seconds). Raising these reduces the panel's\nrecurring CPU/DB load at the cost of slower traffic/online updates.\nHow often local Xray traffic is collected and persisted",
        "maximum": 86400,
        "minimum": 1,
        "type": "integer"
      },
      ...
      "xrayRestartInterval": {
        "description": "How often a pending Xray restart request is applied",
        "maximum": 86400,
        "minimum": 1,
        "type": "integer"
      }
  ...
  "Node": {
    "description": "Node represents a remote dune panel registered with the central panel.\nThe central panel polls each node's existing /panel/api/server/status\nendpoint over HTTP using the per-node ApiToken to populate the runtime\nstatus fields below.",
    "properties": {
      "address": {
  ...
  "Setting": {
    "description": "Setting stores key-value configuration settings for the dune panel.",
    "properties": {
      "id": {
        "type": "integer"
      },
  ...
  "User": {
    "description": "User represents a user account in the dune panel.",
    "properties": {
      "id": {
        "type": "integer"
      },
