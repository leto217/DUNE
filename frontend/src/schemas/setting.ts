...
export const AllSettingSchema = z.object({
  ...
  trafficJobInterval: z.number().int().min(1).max(86400).optional(),
  clientIpJobInterval: z.number().int().min(1).max(86400).optional(),
  nodeHeartbeatInterval: z.number().int().min(1).max(86400).optional(),
  nodeTrafficInterval: z.number().int().min(1).max(86400).optional(),
  xrayRestartInterval: z.number().int().min(1).max(86400).optional(),
