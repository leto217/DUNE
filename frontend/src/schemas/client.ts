...
export const ClientRecordSchema = z.object({
  ...
  fupDailyLimitGB: z.number().optional(),
  fupWeeklyLimitGB: z.number().optional(),
  fupMonthlyLimitGB: z.number().optional(),
  fupAction: z.string().optional(),
  fupDisableHours: z.number().optional(),
  fupResetTime: z.string().optional(),
  fupWeeklyResetDay: z.number().optional(),
  fupMonthlyResetDay: z.number().optional(),
  fup: z.object({
    dailyUsed: z.number().optional(),
    dailyLimit: z.number().optional(),
    weeklyUsed: z.number().optional(),
    weeklyLimit: z.number().optional(),
    monthlyUsed: z.number().optional(),
    monthlyLimit: z.number().optional(),
    status: z.string().optional(),
    disabledUntil: z.number().optional(),
    triggerPeriod: z.string().optional(),
  }).nullable().optional(),
...
export const ClientFormSchema = z.object({
  ...
  fupDailyLimitGB: z.number().min(0),
  fupWeeklyLimitGB: z.number().min(0),
  fupMonthlyLimitGB: z.number().min(0),
  fupAction: z.string(),
  fupDisableHours: z.number().int().min(0),
  fupResetTime: z.string(),
  fupWeeklyResetDay: z.number().int().min(0).max(6),
  fupMonthlyResetDay: z.number().int().min(1).max(28),
